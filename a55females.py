...
def tables_advance_perpetuity():
    ...
    for i in range(sheet.nrows):
        ...
        if x == num:
            dx = sheet.cell_value(num - 1, 1)
            nx = sheet.cell_value(num - 1, 2)
            print('Dx is : ', dx)
            print('Nx is : ', nx)
            ann = nx / dx
...
def tables_advance_term():
    ...
    for i in range(sheet.nrows):
        ...
        if x == num:
            dx = sheet.cell_value(num - 1, 1)
            nx = sheet.cell_value(num - 1, 2)
            nxn = sheet.cell_value((num - 1) + n, 2)
            print('Dx is : ', dx)
            print('Nx is : ', nx)
            print('Nx+n is : ', nxn)
            ann = (nx - nxn) / dx
...
def tables_deferred_advance_term():
    ...
    for i in range(sheet.nrows):
        ...
        if x == num:
            dx = sheet.cell_value(num - 1, 1)
            nm = sheet.cell_value((num - 1) + m, 2)
            nxm = sheet.cell_value((num - 1) + (m + n), 2)
            print('Dx is : ', dx)
            print('Nx+m is : ', nm)
            print('Nx+m+n is : ', nxm)
            ann = (nm - nxm) / dx
...
def tables_deferred_arrears_term():
    ...
    for i in range(sheet.nrows):
        ...
        if x == num:
            dx = sheet.cell_value(num - 1, 1)
            nm = sheet.cell_value(num + m, 2)
            nxm = sheet.cell_value(num + (m + n), 2)
            print('Dx is : ', dx)
            print('Nx+m+1 is : ', nm)
